...
/* Proyecto85 Pro 4.2.2 — corrective update over 4.2 */
...
function render(){
 ...
 host.innerHTML=`<div class="shell"><header><div class="brand"><small>ENTRENADOR PERSONAL</small><h1>Proyecto85 Pro <span class="version">4.2.2</span></h1></div><span class="header-badge">Entrenador85</span></header>${content}</div>${nav()}`;
}
